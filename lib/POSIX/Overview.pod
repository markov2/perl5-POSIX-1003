...
The error constants are provided by M<Errno>.
...
See also the many logging frameworks, like M<Log::Log4perl>,
M<Log::Dispatch>, or M<Log::Report>.
...
Non-standard, but commonly available.  See also M<POSIX::1003::User>.
